...
export type Unnamed_2_Query = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'titleJa' | 'titleEn' | 'descJa' | 'descEn' | 'authorJa' | 'authorEn'>> }> };

export type Unnamed_3_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_3_Query = { allSanityProject: { edges: Array<{ node: (
